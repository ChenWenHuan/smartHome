 ...
 */
public class AddOlderActivity extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mAddOldPersonDialog = new ProgressDialog(AddOlderActivity.this);
    ...
    private void addTopBarToHead()
    {
        ...
        mActionBar = TopBarUtils.createCustomActionBar(AddOlderActivity.this,
    ...
    private void initViews()
    {
        ...
        mEditTextTel = (EditText) findViewById(R.id.et_tel);
    ...
    class AddOldTask extends AsyncTask<String, Void, String>
    {
        ...
        protected String doInBackground(String... params)
        {
            ...
            String result = UserInfoUtil.doAddOld(AddOlderActivity.this,
                    action,
                    mOldDeviceId,
                    mOldPhone,
                    mOldAlias);
