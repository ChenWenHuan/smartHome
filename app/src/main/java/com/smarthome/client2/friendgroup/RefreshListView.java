...
//		initLoadMoreView(context);
	...
	{	
		...
		switch(state)
		{
			case IListViewState.LVS_NORMAL:
			{
				Log.d("!!!!!!!!!!!", "daitm-------convert to IListViewState.LVS_NORMAL");
			...
			case IListViewState.LVS_PULL_REFRESH:
			{
				Log.d("!!!!!!!!!!!", "daitm-------convert to IListViewState.LVS_PULL_REFRESH");
			...
			case IListViewState.LVS_RELEASE_REFRESH:
			{
				Log.d("!!!!!!!!!!!", "daitm-------convert to IListViewState.LVS_RELEASE_REFRESH");
				mHeadProgressBar.setVisibility(View.GONE);
				mArrowImageView.setVisibility(View.VISIBLE);
			...
			{
				Log.d("!!!!!!!!!!!", "daitm-------convert to IListViewState.LVS_LOADING");
