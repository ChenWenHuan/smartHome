...
import com.smarthome.client2.unit.listener.BluetoothManagerListener;
...
//		TLog.Log("zxl---MBluetoothManager---getBondDevices--->"+Preferences.getInstance(context).getIsShowLocalBluetoothData());
//		if(!Preferences.getInstance(context).getIsShowLocalBluetoothData()){
//			return null;
//		}
		...
		while (i.hasNext()){
			...
			if(!TextUtils.isEmpty(d.getName())&&d.getName().equals("KuQi")){
				bondDevices.add(d);
			}
		}
